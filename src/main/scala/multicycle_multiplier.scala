...
class multicycle_multiplier extends Module {
    ...
    val stage1_adders_Sout = Reg(Vec(8, UInt(35.W)))
    val stage1_adders_Cout = Reg(Vec(8, UInt(32.W)))
    ...
    val stage2_adders_Sout = Reg(Vec(4, UInt(39.W)))
    val stage2_adders_Cout = Reg(Vec(4, UInt(36.W)))
    ...
    val stage3_adders_Sout = Reg(Vec(2, UInt(48.W)))
    val stage3_adders_Cout = Reg(Vec(2, UInt(44.W)))
    ...
    val full_adders_Sout = Reg(Vec(15, UInt(8.W)))
    val full_adders_Cout = Reg(Vec(15, UInt(1.W)))
    ...
    for(i <- 0 to 14){
    	full_adders_Sout(i) := full_adders(i).io.Sout
    }
    
    val cin_0 = Reg(UInt(8.W))
    val cin_1 = Reg(UInt(8.W))
    //all cout of adders with 0 carry in
    cin_0 := Cat(full_adders(13).io.Cout, full_adders(11).io.Cout, full_adders(9).io.Cout, full_adders(7).io.Cout, full_adders(5).io.Cout, full_adders(3).io.Cout, full_adders(1).io.Cout, full_adders(0).io.Cout)
    //all cout of adders with 1 carry in
    cin_1 := Cat(full_adders(14).io.Cout, full_adders(12).io.Cout, full_adders(10).io.Cout, full_adders(8).io.Cout, full_adders(6).io.Cout, full_adders(4).io.Cout, full_adders(2).io.Cout, full_adders(0).io.Cout)
    
    val cin = Array(cin_0, cin_1)
    
    val answer_7_0 = full_adders_Sout(0)
    val answer_15_8 = Mux(cin_1(0).asBool, full_adders_Sout(2), full_adders_Sout(1))
    val check_23_16 = (cin_1(0)&cin_1(1)) | ((~cin_1(0))&cin_0(1))
    val answer_23_16 = Mux(check_23_16.asBool, full_adders_Sout(4), full_adders_Sout(3))
    val check_31_24 = (cin_1(0)&cin_1(1)&cin_1(2)) | ((~cin_1(0))&cin_0(1)&cin_1(2)) | (cin_1(0)&(~cin_1(1))&cin_0(2)) | ((~cin_1(0))&(~cin_0(1))&cin_0(2))
    val answer_31_24 = Mux(check_31_24.asBool, full_adders_Sout(6), full_adders_Sout(5))
    ...
    */
    ...
    val answer_39_32 = Mux(check_39_32, full_adders_Sout(8), full_adders_Sout(7))
    ...
    val answer_47_40 = Mux(check_47_40, full_adders_Sout(10), full_adders_Sout(9))
    ...
    val answer_55_48 = Mux(check_55_48, full_adders_Sout(12), full_adders_Sout(11))
    ...
    val answer_63_56 = Mux(check_63_56, full_adders_Sout(14), full_adders_Sout(13))
...
object multicycle_multiplier extends App{
    (new chisel3.stage.ChiselStage).emitVerilog(new multicycle_multiplier())
}
